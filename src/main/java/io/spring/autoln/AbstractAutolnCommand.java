...
class AbstractAutolnCommand {
	...
	static class AutolnOptions {
		...
		@CommandLine.Option(names = "--project-dir", description = "The directory that should be processed. No marker file is necessary", required = true)
		private File projectDir;
	}

	static class ScanOptions {

		@CommandLine.Option(names = "--scan-dir", description = "Indicates that each subdirectory of the scanDir that contains .autoln-scan should be processed as a project-dir", required = true)
		private File scanDir;

		@CommandLine.Option(names = "--maxdepth", description = "the maxdepth levels of a directories to scan when using scan-dir option")
